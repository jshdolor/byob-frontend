...
import { INCREMENT_ITEM, DECREMENT_ITEM, SET_CART_ITEM, SET_CART_ITEMS, RESET_CART } from '~/store/cart/actions';
...
const QuantityModifier = ({ incrementItem, decrementItem, id, disabled = false, quantity, type = { id: 1 } }) => {
