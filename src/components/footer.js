            ...
            <Container className='py-4'>
                <Row>
                    <Col lg={8} className='footer-info'>
                        ...
                        <p>
                            Founded in 1991, NutriAsia Group is a powerhouse of
                            beloved, timeless, and iconic Filipino food brands
                            that include Datu Puti, Silver Swan, Mang Tomas,
                            UFC, Papa Catsup, Jufran; UFC Cooking Sauces and
                            Meal Mixes; Golden Fiesta Cooking Oil; and Locally
                            Blended Juice Drink and Merci Buco Coco water.
                        </p>
                    </Col>
                ...
                <Row className='mt-4 footer-social'>
                    <Col>
                        <span className='mr-3'>
                            <a
                                href='https://www.facebook.com/NutriAsia.Inc/'
                                target='_blank'
                            >
                        ...
                        <span className='mr-3'>
                            <a
                                href='https://youtube.com/nutriasiachannel'
                                target='_blank'
                            >
                        ...
                        <span className='mr-3'>
                            <a
                                href='https://www.linkedin.com/company/nutriasia'
                                target='_blank'
                            >
