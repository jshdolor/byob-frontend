...
class MyAccountTPL extends Component {
  state = { edit: false, visible: false, delete: false, terms: false, others: false };
        ...
        <Modal visible={this.state.delete} onOk={this.handleOk} className='byob-popup delete-account' footer={null} closable={false}>
          ...
          <div className='delete-form'>
            ...
            <div className='checkbox-cont'>
              ...
              <Input placeholder='Others' className='other-input' disabled={!this.state.others} />
            </div>
          </div>
          ...
          <Button type='primary' onClick={this.handleOk} disabled={!this.state.terms}>
            Delete Account
          </Button>
        </Modal>
