...
class SingleProductTPL extends Component {
  ...
  render() {
    ...
    const { description, displayPrice, name, id, image, average_rating } = new ProductModel(this.props.product);
          ...
          <Col sm={24} lg={10} className='product-side'>
            <div className='product-details'>
              ...
              <div className='rating-cont'>
                <StarRatingComponent name='productStarRating' value={average_rating} editing={false} />
              </div>
            ...
            <div className='product-order'>
              ...
              <div className='order-button-cont'>
                ...
                <AddCart product_id={id} className='add-cart-btn'>
                  <Button type='primary' id={id} qty={quantity} size='large'>
                    Add to Cart
                  </Button>
                </AddCart>
              </div>
                    ...
                    <div className='review-lists'>
                      {reviews.map((review, i) => (
                        <div key={i} className='review'>
                          ...
                          <StarRatingComponent name={i + review.name} value={review.rating} editing={false} />
